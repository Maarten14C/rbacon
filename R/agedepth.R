...
# Plum-specific
  ...
  if(model.only)
    panels else { # layout(1) can mess things up if plotting within an existing panel
      ...
      oldpar <- par(mar=mar.middle) # reduce white space
      on.exit(par(oldpar))
