...
# Load the output, if it exists
 ...
 if(length(age.min) == 0)
  ...
  if(!dates.only) {
    ...
    agedepth.ghost(set, rotate.axes=rotate.axes, accordion=accordion, BCAD=BCAD, d.res=d.res, age.res=age.res, rgb.res=rgb.res, dark=dark, rgb.scale=rgb.scale, age.lim=age.lim, use.raster=use.raster)
  }
