...
Bacon will calibrate any C-14 dates, do the MCMC run, calculate age ranges, produce graphs and provide information about the posterior distirbutions and the age-depth model's confidence ranges. The output graph, below, contains a number of panels containing important information (so please don't cut them out for your publications):
