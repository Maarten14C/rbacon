...
vignette: >
  %\VignetteIndexEntry{Post-run analysis}
...
require(rbacon)
1+10
Bacon("MSB2K", ask=FALSE, run=FALSE, coredir=tempdir(), suggest=FALSE)
agedepth()
```
